...

                 {
                     ...
                     items:
                            [
                                          ...
                                          {
                                              margin: '0 0 0 0',
                                              html: '<font size=2 color=white><b>Membership Card Payment Cycle</b></font>'
                                          },
                                           {
                                               xtype: 'spacer',
                ...
                items: [
...

                    {
                        ...
                        itemTpl: '<div class="myContent">' +
                            ...
                            '<div style="overflow:auto;width:100%;height:100%;font-size: 65%;margin:0px 0px 0px -10px"><div style="font-family:Arial, sans-serif;font-size:18px;font-weight:normal;float:left;width:77.5%;"><b>{PaymentCycle}</b></div>' +
