                                ...
                                items:
                                       [
                                                     ...
                                                     },
                                                     {
                                                         ...
                                                         html: '<font size=2 color=white><b>Membership Card Management</b></font>'
                                                     },
                                                      {
                                                          xtype: 'spacer',
...

                                                              {
                                                                  ...
                                                                  width: 70,
                                                                  // margin: '70 0 0 0',
                                                                  id: 'containerFloatPanel_MembershipCardManagementHaiUser',
                                                                  layout: {
                                                                  ...
                                                                  items: [
                                                                      ...
                                                                      {
                                                                          margin: '0 0 0 0',
                                                                          id: 'htmlFloatPanel_MembershipCardManagementHaiUser',
                                                                      ...
                                                                      },
                                                                      {
                                                                          ...
                                                                          width: 70,
                                                                          // margin: '70 0 0 0',
                                                                          id: 'containerFloatPanel_MembershipCardManagementeWallet',
                                                                          layout: {
                                                                          ...
                                                                          items: [
                                                                               {
                                                                                   xtype: 'button',
                                                                                   id: 'btnFloatPanel_MembershipCardManagementeWallet',
                                                                                   margin: '4 0 0 -15',
                                                                                   height: 30,
                                                                                   width: 35,
                                                                                   // iconCls: 'list',
                                                              ...
                                                              },
                                                           {
                                                               ...
                                                               width: 40,
                                                               // margin: '70 0 0 0',
                                                               id: 'containerFloatPanel_MembershipCardManagementPictureUser',
                                                               layout: {
                                                               ...
                                                               items: [
                                                                   {
                                                                       ...
                                                                       width: 40,
                                                                       margin: '0 0 0 -11',
                                                                       id: 'btnFloatPanel_MembershipCardManagementInfo',
                                                                       //badgeText: "2",
                                                          ...
                                                          items: [
                                                                {
                                                                    ...
                                                                    items: [
                                                                         {
                                                                             margin: '10 0 0 0',
                                                                             html: '<div style="color:white;text-align: center;font-size:12px;width:100%;font-weight:bold">MEMBERSHIP CARDS</div>',
                                                                         },
                                                                          {
                                                                              margin: '-10 0 0 0',
...

                                                         {
                                                             ...
                                                             items: [
...

                                                                     {
                                                                         ...
                                                                         width: '50%',
                                                                         html: '<div style="width:100%;text-align:left;color:black;font-family: Arial; font-size:12px;"> &nbsp;&nbsp;&nbsp;&nbsp;Membership Stamp Card</div>'
                                                                     },
                                                         ...
                                                         //  '<table style="border-collapse:collapse;border-spacing:0;width:100%;background-color:#f44336;"><tr><th style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:0px 5px;border-style:none;border-width:2px;overflow:hidden;word-break:normal;text-align:center;border-color:#A2CDF5" rowspan="2"><img src="data:image/png;base64,{FlatBillImgLogo}"style="width: 72px; height: 62px; border:1px solid #A2CDF5; border-radius: 50%; max-width:200px; " /></th><th style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:0px 5px;border-style:none;border-width:2px;overflow:hidden;word-break:normal;border-color:#A2CDF5"><div class="blink_me" style="background-color: #f44336; color: white; padding: 5px 5px;text-align: center; text-decoration: none;font-size: 12px;margin: 0px 0px -20px 170px;cursor: pointer;width:55px" >New</div>{FlatBillWorkshop}<br>Desc:Unifi<br>Account No:1017345941<br>Date:{FlatBillDate}</th></tr><tr><td style="font-family:Arial, sans-serif;font-weight:bold;text-align:center;font-size:16px;padding:0px 5px;border-style:none;border-width:2px;overflow:hidden;word-break:normal;border-color:#A2CDF5;background-color:#1B1C1E;color:white;">Total Paid:RM{FlatBillFinalAmount}</td></tr></table>' +
                                                          ...
                                                          listeners: {
                                                              itemsingletap: function (list, idx, target, records, evt) {
                                                                  ...
                                                                  FloatPanel_MembershipCardManagement_EditCardShow(StampCampaignName, StampCampaignCode, CreatedBy, ModifiedBy, CreatedDate, ModifiedDate, StampCardType, StartDateOnly, EndDateOnly, BackgroundImage, isAnimated, AnimatedInterval
                                                                      , StampRuleRemarks, isStampRulePopUp, LoyaltyCustomerType, StampCampaignPremiumQRCode);

                                                                  Load_FloatPanel_MembershipCardManagement_StampCardLoadByStampCampaignCodeEnterpriseAccNoStore(StampCampaignCode, EnterpriseAccNo)
                                                                  //Ext.getCmp('tabpanelFloatPanel_MembershipCardManagement').setActiveItem(1);
                                                              },
                        ...
                        items: [
                            {
                                ...
                                items: [

                                     {
                                      ...
                                      {
                                          margin: '-12 0 0 0',
                                          html: '<font size=1 color=purple><b><u>Add New Membership Card</u></b></font>'
                                      },
